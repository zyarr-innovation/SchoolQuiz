...
export class QuizService {
  ...
  getLanguageInfo() {
    return this.http.get<string>(
      `${MessageConstant.baseUrl}${MessageConstant.apiGetLanguageInfo}`
    );
  }
  startQuiz() {
    return this.http.get<string>(
      `${MessageConstant.baseUrl}${MessageConstant.apiStartQuiz}`
    );
  }
  stopQuiz() {
    return this.http.get<string>(
      `${MessageConstant.baseUrl}${MessageConstant.apiStopQuiz}`
    );
  }
  nextQuestion() {
    return this.http.get<IQuestion>(
      `${MessageConstant.baseUrl}${MessageConstant.apiNextQuestion}`
    );
  }
  anwerQuestion() {
    return this.http.get<IQuestion>(
      `${MessageConstant.baseUrl}${MessageConstant.apiAnswerQuestion}`
    );
  }
  ...
  getParticipant(id: number) {
    return this.http.get<IParticipant>(
      `${MessageConstant.baseUrl}${MessageConstant.apiGetParticipant}?id=${id}`
    );
  }

  fetchParticipants() {
    return this.http.get<IParticipant[]>(
      `${MessageConstant.baseUrl}${MessageConstant.fetchAddParticipant}`
    );
  }

  deleteParticipant(participant: IParticipant) {
    return this.http.post(
      `${MessageConstant.baseUrl}${MessageConstant.apiRemoveParticipant}`,
      participant
    );
  }
}
