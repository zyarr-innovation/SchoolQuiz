...
export class App {
  ...
  constructor(port: number) {
    this.app = express();
    this.staticPath = path.resolve(
      __dirname,
      "../../../client/dist/test/browser"
    );
  ...
  private setupContentSecurity() {
    const cspConfig = {
      ...
      "script-src": [
        ...
        "'unsafe-inline'",
        "'unsafe-eval'",
        "https://openpgpjs.org", // Explicitly allow this script
        MessageConstant.baseUrl,
      ],
      "style-src": [
        "'self'",
        "'unsafe-inline'",
  ...
  private setupRoutes() {
    ...
    this.app.get(
      MessageConstant.apiGetLanguageInfo,
      quizRoutes.getLanguageInfo
    );
    ...
    this.app.post(
      MessageConstant.apiAddParticipant,
      participantRoutes.addParticipant
    );
    this.app.get(
      MessageConstant.apiGetParticipant,
      participantRoutes.getParticipant
    );
    this.app.post(
      MessageConstant.apiRemoveParticipant,
      participantRoutes.removeParticipant
    );
    this.app.get(
      MessageConstant.fetchAddParticipant,
      participantRoutes.getParticipantList
    );
